...
#render
song.make_midi_file("sk3_test01BassLine.mid")
...
c -> A B C D
d -> A B C D
A -> 36 36 38 36 | 42 36 38 36
B -> 36 38 36 36 | 42 38 36 36
C -> 36 36 42 36 | 42 36 42 36
D -> 36 36 36 36 | 42 36 36 36
"""
...
#render
song.make_midi_file("sk3_test01Drums.mid")
...
#song
song = Song(num_bars=8, ioi=2.5, pitch_generator=pitch_generator, duration_generator=duration_generator, velocity_generator=velocity_generator, generate_every_bar=True)
...
#render
song.make_midi_file("sk3_test01Melody.mid")
